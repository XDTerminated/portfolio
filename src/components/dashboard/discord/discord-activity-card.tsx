    ...
    return (
        <Alert className="flex flex-col items-center gap-3 border-none bg-muted text-center sm:flex-row sm:text-left">
            ...
            <div>
                ...
                <AlertDescription className="line-clamp-1">{activity.timestamps && activity.timestamps.start ? <ElapsedTime unixTimestamp={activity.timestamps.start} /> : null}</AlertDescription>
            </div>
        </Alert>
    );
}
